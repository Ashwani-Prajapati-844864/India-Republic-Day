  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-sm overflow-hidden transition-transform duration-500 bg-white shadow-2xl sm:max-w-md lg:max-w-2xl rounded-2xl hover:scale-105">
        <img src="/rep.png" alt="India" className="object-cover w-full h-64" />
      </div>
      ...
      <div className="w-full max-w-sm p-6 mt-8 text-center bg-white shadow-xl sm:max-w-md lg:max-w-2xl rounded-xl">
        ...
        <p className="text-lg text-gray-800">
          3. ऐतिहासिक महत्व: 1930 में भारतीय राष्ट्रीय कांग्रेस
          ने इसी दिन 'पूर्ण स्वराज' (पूर्ण स्वतंत्रता) की घोषणा की थी, इसलिए इस
          ऐतिहासिक तिथि को संविधान लागू करने के लिए चुना गया।
        </p>
        <p className="text-lg text-gray-800">
          4. लोकतांत्रिक मूल्यों का प्रतीक: यह भारतीय लोकतंत्र की नींव, न्याय, समानता और
          नागरिकों के मौलिक अधिकारों के सिद्धांतों को दर्शाता है।
        </p>
        <p className="text-lg text-gray-800">
          5. राष्ट्रीय एकता: यह दिन 'विविधता में एकता' की भावना को दर्शाता है, जहाँ विभिन्न
          धर्मों और संस्कृतियों के लोग एक साथ मिलकर एक राष्ट्र का निर्माण करते
          हैं।
        </p>
      </div>
    </div>
